 ...
 * @return {Object} - this
 */
function _planetCStudiosColor( backgroundColor, accentHue ) {
 ...
 * @return {Object} - this
 */
_planetCStudiosColor.prototype.setAccentColorsArray = function() {
	var self = this,
		minSaturation = 65,
		maxSaturation = 100,
		minLightness = 30,
 ...
 */
_planetCStudiosColor.prototype.getTextColor = function() {
 ...
 * @return {Color} - Returns a Color object.
 */
_planetCStudiosColor.prototype.getAccentColor = function() {
	var fallback;
...
/**
 * Return a new instance of the _planetCStudiosColor object.
 *
 * @since Planet C Studios 1.0
 *
 * @param {string} backgroundColor - The background color.
 ...
 * @return {Object} - this
 */
function planetCStudiosColor( backgroundColor, accentHue ) {// jshint ignore:line
	var color = new _planetCStudiosColor( backgroundColor, accentHue );
