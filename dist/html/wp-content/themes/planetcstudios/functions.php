...
function planetcstudios_theme_support() {
	...
	if ( is_customize_preview() ) {
		...
		add_theme_support( 'starter-content', planetcstudios_get_starter_content() );
	}
...
require get_template_directory() . '/classes/class-planetcstudios-walker-comment.php';
 ...
 */
function planetcstudios_skip_link_focus_fix() {
...
add_action( 'wp_print_footer_scripts', 'planetcstudios_skip_link_focus_fix' );
 ...
 * @return void
 */
function planetcstudios_non_latin_languages() {
	$custom_css = PlanetCStudios_Non_Latin_Languages::get_non_latin_css( 'front-end' );

	if ( $custom_css ) {
		wp_add_inline_style( 'planetcstudios-style', $custom_css );
	}
}
 ...
 * @return string
 */
function planetcstudios_get_custom_logo( $html ) {
...
add_filter( 'get_custom_logo', 'planetcstudios_get_custom_logo' );
