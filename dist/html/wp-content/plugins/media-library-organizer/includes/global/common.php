<?php
/**
 * Common class. Holds option choices for settings
 * and forms.
 * 
...
class Media_Library_Organizer_Common {
    ...
    public function get_file_type_options() {
        ...
        $options['detached'] = __( 'Unattached' );
        $options['mine'] = _x( 'Mine', 'media items' );
     ...
     * @param   array   $insert     Array data to insert
