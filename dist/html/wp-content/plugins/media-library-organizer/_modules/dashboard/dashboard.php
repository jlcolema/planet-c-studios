...
class WPZincDashboardWidget {  
    ...
    public function admin_scripts_css() {    
        ...
        // JS
        wp_register_script( 'wpzinc-admin-autocomplete', $this->dashboard_url . 'js/' . ( $ext ? 'min/' : '' ) . 'autocomplete' . ( $ext ? '-min' : '' ) . '.js', array( 'jquery', 'jquery-ui-autocomplete' ), $this->plugin->version, true );
